        ...
        <div class="container mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                <div class="flex items-center">
                    <h1 class="text-xl text-blue-500 font-semibold">Inbox</h1>
                </div>
...
$callingInbox = mysqli_query($connect, "SELECT * FROM mail JOIN accounts ON mail.user_by = accounts.user_id WHERE user_to='$myUserId' and isDraft='0'");
