        ...
        <div class="container mx-auto px-4">
            <div class="flex justify-between items-center py-4">
                <div class="flex items-center">
                    <h1 class="text-xl text-blue-500 font-semibold">Outbox(sent mail)</h1>
                </div>
...
$callingInbox = mysqli_query($connect, "SELECT * FROM mail JOIN accounts ON mail.user_to = accounts.user_id WHERE user_by='$myUserId' and isDraft='0'");
...
?>
    <div class="bg-white p-4 my-2 shadow-md rounded-lg">
        <div class="flex justify-between items-center">
            ...
            <p class="text-gray-600">just min ago</p>
        </div>
    </div>
<?php 
} // End of while loop
